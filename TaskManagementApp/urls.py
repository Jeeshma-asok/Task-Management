...
schema_view = get_schema_view(
    ...
    public=True,
    permission_classes=(permissions.AllowAny,),  # Important: Allow any user to access swagger docs
    authentication_classes=[],   # Change to IsAdminUser if you want protection
)
